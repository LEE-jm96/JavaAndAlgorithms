...
[9. 백준14713 앵무새](#백준14713-앵무새)</br>
[10. 백준10773 제로](백준10773-제로)</br>
...
> 한 앵무새가 말하는 것을 하나의 큐에 넣어줍니다.
> 그리고 앵무새 큐를 리스트에 담아줍니다.
> 그리고 cestream이 받아적은 문장을 공백 단위로 받아와서 리스트에 있는 큐와 확인작업을 합니다.
>> 확인 1) cestream과 리스트에 있는 큐를 확인
>> 확인 2) cestream은 지워졌는데 앵무새 큐가 남은경우
>>> 확인 2때문에 시간을 좀 많이 허비 했다.


## 백준10773 제로

> 스택에 숫자를 계속 집어넣다가 0이라는 숫지가 나오면 스택에서 숫자를 뺴주면 되는 문제 입니다.
